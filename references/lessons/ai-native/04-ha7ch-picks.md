...
> 按学生 `interests` 挑 1-2 篇深聊，把前几课的内核连成面。

## 怎么用这节课
前面 01/02 讲了零 token 的"内核"，03 让学生亲手做了一个。这节把 HA7CH 的其他思考按主题接上去。**导师按学生兴趣选，不是逐篇念**。每篇给学生一句话勾一下，问他"这个方向你想不想展开"，想深入就用 `WebFetch` 取原文一起读。
