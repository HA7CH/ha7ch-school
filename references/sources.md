...
| Lawted 企业 Skill 持续改进观点（`references/material/enterprise-skill-feedback-loop.md`，**学生机上不存在**） | 既有公开观点蒸馏 + 明示为新设计的教学练习 | **候选素材；来源分层，近期视频未读全不作新增证据；补充纠正到规则分发的验收动作，未编入讲义，导师上课时不读** |
